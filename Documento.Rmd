...
```{r grafiuno,fig.width=5, fig.height=3,fig.align = "center", echo=FALSE, fig.cap="\\label{fig:figs}Cantidad de Avisos por Barrio", out.extra='', fig.pos="H"}
##ANALISIS DE LA BASE##
library(ggplot2)
library(ggthemes)
...
```{r graficuatro,fig.width=5, fig.height=3,fig.align = "center", echo=FALSE, warning=FALSE, fig.cap="\\label{fig:figs}Distribución del Metraje de los Inmuebles por Tipo", out.extra='', fig.pos="H"}
